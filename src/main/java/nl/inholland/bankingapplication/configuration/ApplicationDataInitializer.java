...
public class ApplicationDataInitializer implements ApplicationRunner {
    ...
    private void loadBackAccounts() {
        List.of(
                ...
                new BankAccountRegisterDTO(BankAccountType.CURRENT, 5L),
    ...
    public void loadUserAccounts(){
        List.of(
                ...
                new UserAccountDTO("Jun", "Feng", "junfeng@gmail.com", "JunFeng", "secret123", UserAccountType.ROLE_EMPLOYEE, "+31222222222", 12345222, 1000.00, 250.00),
